 ...
 */
class GroupEvent extends \StudentInfo\Models\GroupEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'group', 'id', 'type', 'description', 'datetime', 'notifications', 'classrooms', 'organisation'];
        }
    ...
    {
        if (!$this->__isInitialized__) {
            $this->__initializer__ = function (GroupEvent $proxy) {
