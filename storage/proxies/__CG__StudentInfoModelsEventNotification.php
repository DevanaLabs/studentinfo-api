 ...
 */
class EventNotification extends \StudentInfo\Models\EventNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'event', 'id', 'description', 'organisation', 'expiresAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventNotification $proxy) {
