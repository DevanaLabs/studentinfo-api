 ...
 */
class CourseEvent extends \StudentInfo\Models\CourseEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'course', 'id', 'type', 'description', 'datetime', 'notifications', 'classrooms', 'organisation'];
        }
