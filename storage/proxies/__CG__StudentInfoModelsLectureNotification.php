 ...
 */
class LectureNotification extends \StudentInfo\Models\LectureNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'lecture', 'id', 'description', 'organisation', 'expiresAt'];
        }
